...
local FOLDER_PICKER_SCRIPT_PATH = filesystem.filesystem.get_awesome_config_dir("assets/scripts") .. "folder-picker.lua"
local FILE_PICKER_SCRIPT_PATH = filesystem.filesystem.get_awesome_config_dir("assets/scripts") .. "file-picker.lua"
