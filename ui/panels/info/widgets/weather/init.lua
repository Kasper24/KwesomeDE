...
local weather_codes_map = {
	-- Clear sky
	[0] = { icon = beautiful.icons.weather.clear, desc = "Clear sky" },

	-- Mainly clear, partly cloudy, and overcast
	[1] = { icon = beautiful.icons.weather.mainly_clear, desc = "Mainly clear" },
	[2] = { icon = beautiful.icons.weather.partly_cloudy, desc = "Partly cloudy" },
	[3] = { icon = beautiful.icons.weather.partly_cloudy, desc = "Overcast" },

	-- Fog and depositing rime fog
	[45] = { icon = beautiful.icons.weather.fog, desc = "Fog" },
	[48] = { icon = beautiful.icons.weather.fog, desc = "Depositing rime fog" },

	-- Drizzle: Light, moderate, and dense intensity
	[51] = { icon = beautiful.icons.weather.drizzle, desc = "Light drizzle" },
	[53] = { icon = beautiful.icons.weather.drizzle, desc = "Moderate drizzle" },
	[55] = { icon = beautiful.icons.weather.drizzle, desc = "Dense drizzle" },

	-- Freezing Drizzle: Light and dense intensity
	[56] = { icon = beautiful.icons.weather.drizzle, desc = "Light freezing drizzle" },
	[57] = { icon = beautiful.icons.weather.drizzle, desc = "Dense freezing drizzle" },

	-- Rain: Slight, moderate, and heavy intensity
	[61] = { icon = beautiful.icons.weather.rain, desc = "Slight rain" },
	[63] = { icon = beautiful.icons.weather.rain, desc = "Moderate rain" },
	[65] = { icon = beautiful.icons.weather.rain, desc = "Heavy rain" },

	-- Freezing Rain: Light and heavy intensity
	[66] = { icon = beautiful.icons.weather.rain, desc = "Light freezing rain" },
	[67] = { icon = beautiful.icons.weather.rain, desc = "Heavy freezing rain" },

	-- Snowfall: Slight, moderate, and heavy intensity
	[71] = { icon = beautiful.icons.weather.snow, desc = "Slight snow" },
	[73] = { icon = beautiful.icons.weather.snow, desc = "Moderate snow" },
	[75] = { icon = beautiful.icons.weather.snow, desc = "Heavy snow" },

	-- Snow grains
	[77] = { icon = beautiful.icons.weather.snowflake, desc = "Snow grains" },

	-- Rain showers: Slight, moderate, and violent
	[80] = { icon = beautiful.icons.weather.shower, desc = "Slight rain shower" },
	[81] = { icon = beautiful.icons.weather.shower, desc = "Moderate rain shower" },
	[82] = { icon = beautiful.icons.weather.shower, desc = "Violent rain shower" },

	-- Snow showers: Slight and heavy
	[85] = { icon = beautiful.icons.weather.shower, desc = "Slight snow shower" },
	[86] = { icon = beautiful.icons.weather.shower, desc = "Heavy snow shower" },

	-- Thunderstorm: Slight or moderate
	[95] = { icon = beautiful.icons.weather.thunder, desc = "Slight or moderate thunderstorm" },

	-- Thunderstorm with slight and heavy hail
	[96] = { icon = beautiful.icons.weather.thunder, desc = "Thunderstorm with slight hail" },
	[99] = { icon = beautiful.icons.weather.thunder, desc = "Thunderstorm with heavy hail" },
}
...
local function new()
	...
	weather_daemon:connect_signal("weather", function(self, result)
		...
		current_weather_widget
			:get_children_by_id("temp")[1]
			:set_text(gen_temperature_str(result.current.temperature_2m))
		current_weather_widget
			:get_children_by_id("feels_like_temp")[1]
			:set_text("Feels like " .. gen_temperature_str(result.current.apparent_temperature))
		current_weather_widget
			:get_children_by_id("description")[1]
			:set_text(weather_codes_map[result.current.weather_code].desc)
		current_weather_widget
