...
local function new()
    ...
    ret:new("edge", "b", "microsoft-edge", "Microsoft-edge")
    ...
    ret:new("yazi", "r", "kitty --class file-manager yazi", "file-manager", {
        run_or_raise = false
    })
    ret:new("nautilus", "f", "nautilus", "org.gnome.Nautilus", {
        run_or_raise = false
    })
    ...
    ret:new("resources", "Delete", "resources", "resources", {
